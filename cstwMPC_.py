# -*- coding: utf-8 -*-
"""
Created on Sun Apr 16 21:02:21 2017
...
from Impatience import ImpatienceCondition
...
if __name__ == "__main__":
    ...
    def betaDistObjective(nabla):
        ...
        if Params.do_tractable:
            ...
            top = InfiniteType.PermGroFac[0]/(InfiniteType.Rfree*1.00326*0.99375)        
    ...
    if Params.run_estimation:
        ...
        ImpatienceCondition(CRRA=Params.CRRA,DiscFac=DiscFac,N=Params.pref_type_count,nabla=nabla,Rfree=InfiniteType.Rfree,PermShkStd=InfiniteType.PermShkStd,PermGroFac=InfiniteType.PermGroFac[0],Unemp=InfiniteType.UnempPrb,PermShkCount=InfiniteType.PermShkCount,PermShkDstn=InfiniteType.PermShkDstn)
